...
pipeline = Pipeline().add_passes(PreProcessPass, FindContours, FilterByLength, OcrPass(ocr_options=[5, 6, 12]))  # TODO: CRIAR PASSO RESIZE

cap = cv2.VideoCapture(f"project/res/videos/10.mp4")
ret, frame = cap.read()
